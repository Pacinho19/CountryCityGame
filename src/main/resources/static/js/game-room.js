            ...
            function updatePlayers(startGame) {
                var gameId = document.getElementById('gameId').value;
                $.post("/country-city-game/games/" + gameId + "/room/players").done(function (fragment) {
            ...
            function loadingGame(){
                ...
                var downloadTimer = setInterval(function(){
                  if(timeleft <= 0){
                    ...
                    window.location.href = '/country-city-game/games/'+ document.getElementById('gameId').value;
                  }
